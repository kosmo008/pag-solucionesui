<nav class="wrapper h-20 flex items-center justify-between bg-transparent shadow-2xl  ">
    ...
    <div
        class="fixed inset-0 bg-gradient-to-b from-white/70 to-black/70 translate-x-full peer-checked:translate-x-0 transition-transform  md:static md:translate-x-0 md:bg-none">
        <ul
        ...
        md:w-max md:bg-transparent md:p-0 md:grid-flow-col md:static">
            <li>
                <a href="{{ route('home') }} "
                    class="inline-flex text-lg hover:text-[#1E76BC] hover:border-gray-950 hover:-translate-y-1 hover:underline duration-150 translate-all">
                    {{ __('Home') }}
                </a>
            </li>
            <li>
